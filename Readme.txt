...
[表示のON/OFF]
・ Shift + Q : ウィンドウの透過率を「5%（ほぼ非表示）」と「設定値」とで切り替えます。

[キャプチャ範囲の再設定]
・「範囲変更」ボタン、または Shift + W : キャプチャ範囲を再選択します。（選択後は操作モードで開始します）
...
[その他の操作]
・「閉じる」ボタン、または Shift + E : 確認後、アプリケーションを終了します。（現在の設定は自動保存されます）


■ 更新履歴

2025/07/04 - Version 1.1.3
